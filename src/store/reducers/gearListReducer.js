const initState = {
  gearLists: [
    ...
    //     {
    //       categoryName: 'clothing',
    //       id: 'c4af3f96-5e38-4d84-b331-551d26b31f15',
    //       list: [
    //         {
    //           name: 'hiking boots',
    //           id: '1sd15b0adc-9670-4eb2-8f6f-eb12fb12e3a4',
    ...
    //         {
    //           name: 'hat',
    //           id: 'd5d4425a-g9c5-4d63-9eba-22db7eed3452',
    //           weight: 0.235,
    //           qty: 1,
    //         },
    //       ],
...
const gearListsReducer = (state = initState, action) => {
  switch (action.type) {
    case 'CREATE_GEAR_LIST':
      // console.log('create list from reducer', action.listData);
